...
const Footer = () => {
  return (
    <div className="w-full flex flex-col xl:flex-row xl:justify-between bg-[#000] text-[#fff] px-[26px] lg:px-[61.92px] pt-[33px] lg:pt-[78.59px] pb-[24px] lg:pb-[88.24px] xl:gap-[202px]">
