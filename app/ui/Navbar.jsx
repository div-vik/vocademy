  ...
  return (
    <nav className="flex justify-around items-center mt-[75px] md:mt-[97px] lg:mt-[43px] px-[25px] md:px-[79px] lg:px-[110px]">
      ...
      <div className=" hidden xl:flex flex-1 justify-end items-center">
        <Link href="/register">
          <button className="rounded-[33px] px-[35px] py-[13px] bg-opacity-70 hover:bg-gradient-to-r hover:from-[#000] hover:to-[#000] ease-in-out duration-500 hover:text-[#fff] bg-gradient-to-r from-secondaryPink from-20% to-secondaryBlue to-60% text-[13px] font-bold">
            register now
          </button>
        </Link>
      </div>
