...
const FeedbackCard = ({ name, review, designation }) => {
  return (
    <div className="flex w-[218.667px] lg:w-[483.922px] xl:w-[483.92px] h-[182px] lg:h-[402.776px] xl:h-[402.78px] rounded-[27.112px] lg:rounded-[60px] bg-gradient-to-r from-ternaryPink to-primaryBlue relative">
      <div className="w-fit h-fit flex justify-center items-start text-[57.839px] lg:text-[128px] font-normal text-[#000] pl-5 lg:pl-[60px]">
        <span className={zcool.className}>&quot;</span>
      </div>

      <div className="flex flex-col justify-center items-center pl-[5px] pr-[20px] lg:pr-[76px]">
        <div className="text-[9.037px] pt-16 xl:pt-20 text-left lg:text-base xl:text-[15px] font-normal leading-[16.719px] lg:leading-[37px] text-[#000]">
