...
const FeedbackCard = ({ name, review, designation }) => {
    return (
        <div className="flex w-[218.667px] lg:w-[483.922px] xl:w-[483.92px] h-[182px] lg:h-[402.776px] xl:h-[402.78px] px-1 lg:px-5 rounded-[27.112px] lg:rounded-[60px] bg-gradient-to-r from-ternaryPink to-primaryBlue relative">
            <div className="w-fit h-fit inline-flex justify-center items-start text-[57.839px] lg:text-[128px] font-normal text-[#000] pl-5 lg:pt-5">
                ...
                <Image
                    className="w-[25px] h-[58px] lg:w-[60px]"
                    src="/quot.svg"
                    alt="quot"
                    width={25}
                    height={58}
            ...
            <div className="flex flex-col relative pt-2 lg:pt-[10px] lg:pl-2">
                <div className="mt-[30px] lg:mt-[45px] pl-2 text-[7.23px] w-[144.596px] lg:w-[320px] xl:w-[341px] lg:text-base xl:text-[15px] text-justify font-normal leading-[16.719px] lg:leading-[37px] text-[#000]">
                    <p className="same-font">{review}</p>
                </div>
