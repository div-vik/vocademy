  ...
  return (
    <div className="flex flex-col justify-center items-center mx-[25px] border-[#FF7EBC] rounded-[24.796px] mt-[37px] border-[1.494px] relative">
      <div className="px-[49px] flex flex-col justify-center items-center">
        ...
        <p className="mt-[4.24px] text-[19.277px] font-bold text-center">
      ...
      <div className="flex justify-end w-full items-center mt-[14.25px]">
        <div className="flex justify-between items-center w-1/2">
          ...
          <div className="w-[61.447px] h-[60.989px] mb-[16.01px] mr-[18.55px]">
            <Image
              src="/contact2.svg"
              alt="contact"
              width={61.447}
