...
const TopicCard = ({ icon, title }) => {
  return (
    <div className="bg-[#75FCFF] w-[80.9px] lg:w-[147.345px] h-[123px] lg:h-[224.493px] flex flex-col justify-center items-center rounded-[16.48px] lg:rounded-[30px] px-[13.9px] shadow-[0_2.197px_2.197px_0px_rgba(0,0,0,0.3)] lg:shadow-[0_4px_4px_0px_rgba(0,0,0,0.3)]">
