          ...
          <form className="flex flex-col">
            <div className="lg:w-[527.053px] xl:w-[405px]">
              <div className="flex flex-col lg:text-right lg:flex-row items-center">
                ...
                <input
                  className="w-full h-[32px] lg:h-[46.849px] xl:h-[36px] border-[2px] lg:border-[3.9px] xl:border-[3px] rounded-[9.73px] lg:rounded-[18.2px] xl:rounded-[14px] mt-[18px] lg:mt-0 lg:ml-[28.38px] xl:ml-[22px] border-primaryPink"
                  type="text"
                />
              </div>
              ...
              <div className="flex flex-col lg:text-right lg:flex-row items-center">
                ...
                <input
                  className="w-full h-[32px] lg:h-[46.849px] xl:h-[36px] border-[2px] lg:border-[3.9px] xl:border-[3px] rounded-[9.73px] lg:rounded-[18.2px] xl:rounded-[14px] mt-[18px] lg:mt-[31.23px] lg:ml-[28.38px] xl:ml-[22px] border-primaryPink"
                  type="password"
                />
              </div>
            </div>
